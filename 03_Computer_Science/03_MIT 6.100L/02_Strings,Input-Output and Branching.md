...
- [x] 字符串拼接与重复：`b = ":"; c = ")"; s1 = b + 2*c` 的结果是什么？ ✅ 2026-02-06
- [x] `s = "ABC d3f ghi"`：分别求 `s[3:len(s)-1]`、`s[4:0:-1]`、`s[6:3]` ✅ 2026-02-06
- [x] 输入动词并输出：`I can <verb> better than you!`，再打印该动词 5 次 ✅ 2026-02-06
- [x] 保存 secret number，输入猜测，打印 True/False 是否相等 ✅ 2026-02-06
- [x] 猜数字：判断“太低/太高/相等” ✅ 2026-02-06
- [x] 修正缩进错误的 if 代码（语义结构与视觉结构一致） ✅ 2026-02-06
