下面我按你给的 Phase 1–3 走完：先给“课程组合（Curriculum Stack）”，再把每门课的“可排程大纲”结构化出来（基于公开页面/目录，不编造讲次），最后给 26 周、精确到天的执行表。

  

我先声明两条边界（避免你后面执行时踩坑）：

1. 你周末要“整块给毕业设计+休整”，但你也要求“每天4–6小时”。我这里把“每天4–6小时”理解为“学习/产出时间（含毕业设计）”，周末主任务是毕业设计，但仍保留 30–60 分钟的“轻量复盘 + 最小实现/测试”，以满足你“每天都有从零实现”的硬约束。
    
2. 你要求“同时推进主课≤2门”。我把“主课”定义为：需要连续听课 + 成体系作业/实验的课程。其余（SQL、工程化、数学补课）按“周内固定训练槽”嵌入，不算主课名额，但依然严格排程与验收。
