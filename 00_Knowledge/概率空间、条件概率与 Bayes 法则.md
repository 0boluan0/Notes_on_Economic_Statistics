...
> **继续：** 时间结构进入 [[随机过程基础|随机过程、平稳性与遍历性]]；有限样本空间中的随机计数进入 [[指示变量与随机计数|离散概率]]。
> <!-- bilingual-en:start -->
...
> **Continue with:** For time-indexed uncertainty, go to [[随机过程基础|stochastic-process foundations]]. For random counts in finite sample spaces, go to [[指示变量与随机计数|indicator variables and random counts]].
> <!-- bilingual-en:end -->
