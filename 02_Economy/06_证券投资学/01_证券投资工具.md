...
##### **(1). 延付年金现值**(**(1) Present Value of Ordinary Annuity**)
...
##### **(3). 后付年金终值(累积值)**(**(3) Future Value of Ordinary Annuity (Accumulated Value)**)
...
~~[[Pasted image 20250226152919.png]]~~ (已转文字)
...
~~[[Pasted image 20250304201422.png]]~~ (已转文字)
—s a a * & see , 管 |* 基金 会 计 基金 清算 a 理 银 公 一 一 一 一 | 代销 基金 司 行 直属 ——— 7
~~[[Pasted image 20250304201431.png]]~~ (已转文字)
