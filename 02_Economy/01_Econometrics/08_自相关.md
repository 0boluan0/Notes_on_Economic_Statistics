...
$$ -\hbar(s_{i}s_{j})\underbrace{\times0}_{\to\ 0\mathsf{H}}|i{\mathsf{~}}j\subseteq T,i\rlap{/}{\to}j\delta $$
~~[[Pasted image 20240613134707.png]]~~ (已转文字)

$$ \Xi_{\it{t}}\longrightarrow\ M\Xi_{\it{t-1}\perp}+M_{\it{t}} $$
~~[[Pasted image 20240613170503.png]]~~ (已转文字)
