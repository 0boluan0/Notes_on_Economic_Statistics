...
Because the [[收入效应与替代效应|income and substitution effects]] work in opposing directions, the information given is not enough to determine the answer.
<!-- bilingual-en:end -->
...
<!-- bilingual-en:start -->
Compare the before-and-after change in the treatment group with the corresponding change in the control group.
<!-- bilingual-en:end -->

事实上，经济学很难进行实地的控制变量分析，所以只能统计过去发生过的事情然后人为分组。（准实验研究）
<!-- bilingual-en:start -->
Because controlled field experiments are often difficult in economics, researchers frequently analyse past events and construct comparison groups. This is a form of quasi-experimental research.
<!-- bilingual-en:end -->
