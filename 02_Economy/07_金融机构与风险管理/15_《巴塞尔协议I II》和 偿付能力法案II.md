...
&nbsp;
**1.** **Historical Basel I/II minimum total capital = 8% × RWA.**<br>
**2.** **Banking-book RWA = exposure × risk weight.**<br>
**3.** **The 1996 internal-model approach used ten-day VaR and a regulatory multiplier.**<br>
**4.** **Backtesting multiplier:** 0–4 exceptions → 3.00; 5 → 3.40; 6 → 3.50; 7 → 3.65; 8 → 3.75; 9 → 3.85; 10 or more → 4.00.<br>
**5.** **Recognised netting reduced the add-on through $0.4+0.6\times\text{NGR}$.**<br>
**6.** **Historical interest-rate add-ons:** 0 / 0.5 / 1.5%.<br>
<!-- bilingual-en:end -->
...
&nbsp;
**1.** **Reduce the probability of failure and preserve confidence.** Eliminating bank failure altogether is unrealistic, but sufficient loss-absorbing capital can make it much less likely and support public and corporate confidence in the financial system.<br>
<!-- bilingual-en:end -->
...
&nbsp;
**2.** **Limit moral hazard created by deposit insurance.** When deposits are insured, banks may be tempted to take greater risks with protected funding. Mandatory capital makes aggressive leverage more costly to bank owners.<br>
<!-- bilingual-en:end -->
...
&nbsp;
**3.** **Limit systemic risk.** The failure of a large, interconnected bank can transmit losses and liquidity stress to other institutions. Capital requirements provide one layer of protection against that contagion.<br>
<!-- bilingual-en:end -->
...
&nbsp;
**1.** **Give netting agreements legal enforceability.** An ISDA Master Agreement cannot reduce exposure in insolvency unless the applicable legal regime permits close-out and offset of positive and negative replacement values.<br>
<!-- bilingual-en:end -->
...
&nbsp;
**2.** **Promote fair and transparent markets.** Improve disclosure about derivative activity and reduce information asymmetry.<br>
<!-- bilingual-en:end -->
...
&nbsp;
**3.** **Require supervisors to assess the quality of banks' VaR and stress testing** and reflect deficiencies in supervisory action or capital.<br>
<!-- bilingual-en:end -->
...
&nbsp;
**4.** **Coordinate supervision across borders.** This limits regulatory arbitrage and improves oversight of complex cross-border derivative activity.<br>
<!-- bilingual-en:end -->
...
| --- | --- | --- |
| **Payment netting** | Offset cash flows due on the same settlement date and transfer only the net amount | Reduces the amount awaiting payment before a default occurs |
...
&nbsp;
**1.** **Current Exposure Method (CEM)**<br>
<!-- bilingual-en:end -->
...
&nbsp;
**5.** The 1996 Market Risk Amendment<br>
<!-- bilingual-en:end -->
 ...
 **2️⃣ 两条路线：**
<!-- bilingual-en:start -->
| **Gap** | **What Basel I did not adequately cover** | **Why it mattered** |
| --- | --- | --- |
...
&nbsp;
**1.** **Calculate one-day 99% VaR each day** from at least one year of history or an approved simulation model.<br>
**2.** **Convert to a ten-day horizon** under the historical square-root rule: $VaR_{10d}=VaR_{1d}\times\sqrt{10}$.<br>
**3.** **Apply the regulatory multiplier $m_c$:** $\text{Capital}_{MR}=\max\!\left(VaR_{t-1},\,m_c\overline{VaR}_{60}\right)$ under the simplified historical presentation here.<br>
...
| ------------------------- | ------------------- | ---------------------------------------------------- |
| **Pillar 1 最低资本金要求**      | _“到底要放多少钱当安全垫？”_    | 依照 **信用风险 + 市场风险 + 操作风险** 三块算 **RWA**，再 × 8 % 得所需资本。 |
| **Pillar 2 监管审查过程 (SRP)** | _“公式没覆盖的风险怎么办？”_    | 银行自己做 **ICAAP**（内部资本评估），监督机关可要求加码资本或限额。              |
| **Pillar 3 市场纪律**         | _“光靠官方盯不够，得让市场也盯。”_ | 公开披露 VaR、RWA、PD / LGD 等关键信息，投资者会“用钱投票”。              |
<!-- bilingual-en:start -->
...
<!-- bilingual-en:start -->
- The 1996 amendment's historical VaR-and-multiplier approach was incorporated into the market-risk component of Basel II.
...
操作风险（Basel I 完全没管到的“新成员”）
<!-- bilingual-en:start -->
Operational risk, a major category that Basel I did not explicitly capitalise.
<!-- bilingual-en:end -->
...
&nbsp;
**1.** **Does ICAAP cover every material risk?**<br>
**2.** **Is the capital buffer sufficient under stress?**<br>
**3.** **Are governance, internal audit, and data quality adequate?**<br>
<!-- bilingual-en:end -->
...
<!-- bilingual-en:start -->
- The **ten-day 99% VaR** convention belongs to the historical Basel market-risk internal-models framework; current FRTB market-risk rules use expected shortfall and liquidity horizons instead.
<!-- bilingual-en:end -->
...
<!-- bilingual-en:start -->
*1. Solvency II's Three Pillars, Compared with the Basel Structure*
<!-- bilingual-en:end -->
...
<!-- bilingual-en:start -->
| **Solvency II** | **Closest Basel analogue** | **Plain-language memory cue** |
| --- | --- | --- |
...
&nbsp;
**1.** **Market risk**, including interest rates, equities, foreign exchange, property, spreads, and concentration<br>
**2.** **Life underwriting risk**, including mortality, longevity, expenses, and lapse<br>
**3.** **Non-life underwriting risk**, including premium, reserve, and catastrophe risk<br>
**4.** **Health underwriting risk**<br>
**5.** **Counterparty default risk**<br>
**6.** **Operational risk**, calculated outside the basic-solvency-capital aggregation in the standard formula<br>
<!-- bilingual-en:end -->
...
> <!-- bilingual-en:start -->
> **Comparison:** The historical Basel presentation first calculated RWA and then applied capital ratios. Solvency II instead aggregates risk-module capital charges to obtain a euro amount of required insurer own funds.
> <!-- bilingual-en:end -->
...
<!-- bilingual-en:start -->
| **Item** | **Historical Basel convention in these notes** | **Solvency II** |
| --- | --- | --- |
| Market-risk horizon and tail measure | Ten-day 99% VaR under the old IMA | One-year 99.5% VaR calibration for the SCR |
| Operational risk | Historical BIA, TSA, or AMA | Separate standard-formula charge or internal-model component |
...
&nbsp;
**1.** **Compare the competitive structures of the two industries**<br>
<!-- bilingual-en:end -->
...
&nbsp;
**1.** **Information contagion:** investors and depositors may question the asset quality of other banks, causing withdrawals and a contraction in interbank funding.<br>
<!-- bilingual-en:end -->
...
&nbsp;
**2.** **Direct balance-sheet contagion:** interbank loans, derivative exposures, and payment-system obligations can transmit default losses to counterparties.<br>
<!-- bilingual-en:end -->
...
&nbsp;
**3.** **Liquidity runs:** deposits and wholesale funding may flee to cash, money-market funds, or perceived safe banks, raising surviving banks' funding costs.<br>
<!-- bilingual-en:end -->
...
&nbsp;
**3.** **Regulatory and reputational effects**<br>
<!-- bilingual-en:end -->
...
<!-- bilingual-en:start -->
Under the historical Basel I current-exposure method and with no netting agreement, calculate the capital required for these transactions with a corporate counterparty:
...
<!-- bilingual-en:start -->
The historical OTC-derivatives amendment to Basel I calculates **counterparty credit-risk capital** as follows:
<!-- bilingual-en:end -->
...
&nbsp;
**1.** **Calculate current exposure (CE)**<br>
<!-- bilingual-en:end -->
...
<!-- bilingual-en:start -->
| Item | Notional (USD) | Maturity | Positive CE | Add-on | PFE | CEA | RWA | Capital at 8% |
| --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: |
...
| **Dominant regulatory risk** | **Market risk**, including rates, FX, equities, spreads, and options | **Credit risk**, plus banking-book interest-rate and other risks |
| **Historical capital method used in the exercise** | Ten-day 99% VaR × multiplier plus specific risk, before later sVaR, IRC, and FRTB reforms | Standardised credit RWA or IRB using PD, LGD, EAD, and maturity |
...
&nbsp;
**1.** Illustrative capital for the banking-book loan<br>
<!-- bilingual-en:end -->
...
&nbsp;
**2.** Illustrative capital if the bond qualifies for the trading book<br>
<!-- bilingual-en:end -->
...
<!-- bilingual-en:start -->
- Use the historical market-risk VaR method under Basel II, before the Basel 2.5 sVaR and IRC additions.
...
> <!-- bilingual-en:start -->
> **Result under the exercise's assumptions:** capital falls by about **USD 500,000** if the loan is replaced by a bond that genuinely qualifies for the trading book and has VaR equal to 1% of notional. This is not an automatic consequence of issuing a bond: trading-book classification depends on trading intent, governance, and regulatory eligibility. Under Basel 2.5, sVaR and IRC could raise the trading-book charge to or above USD 800,000, narrowing the arbitrage.
> <!-- bilingual-en:end -->
...
&nbsp;
**1.** Define the two books and identify the applicable risk framework.<br>
**2.** Calculate the loan under the standardised credit-risk approach: capital = 8% of RWA.<br>
**3.** Under the exercise's historical trading-book assumption, calculate the bond charge as $K=m\times VaR$.<br>
**4.** Compare the two results and explain both the direction and the assumptions behind the change.<br>
<!-- bilingual-en:end -->
...
<!-- bilingual-en:start -->
- **Regulatory arbitrage** occurs when a bank uses legally available differences, gaps, or measurement choices in regulation to reduce reported RWA or required capital without a commensurate reduction in the underlying economic risk.
<!-- bilingual-en:end -->
...
&nbsp;
**2.** **Securitisation and sale**<br>
<!-- bilingual-en:end -->
        
        - 打包次级贷款发行 MBS/CDO，将风险转移至投资者，仅保留表外信用支持，RWA 显著下降。
<!-- bilingual-en:start -->
- Package loans into MBS or CDO structures, transfer them to investors, and retain only selected off-balance-sheet support, thereby reducing reported RWA even when residual risk remains.
<!-- bilingual-en:end -->
...
&nbsp;
**3.** **Exploit differences in risk weights**<br>
<!-- bilingual-en:end -->
...
&nbsp;
**4.** **Off-balance-sheet structures**<br>
<!-- bilingual-en:end -->
...
&nbsp;
**5.** **Optimise internal-model assumptions**<br>
<!-- bilingual-en:end -->
        
        - 调整 PD、LGD、资产相关系数估计，使内部模型输出的资本需求低于实际风险。
<!-- bilingual-en:start -->
- Choose aggressive estimates of PD, LGD, correlations, or other parameters so that an IRB or AMA model produces less capital than the true risk would justify.
<!-- bilingual-en:end -->
...
<!-- bilingual-en:start -->
- **Greater regulatory complexity** encourages successive reforms, including Basel II, Basel 2.5, and Basel III.
<!-- bilingual-en:end -->
...
&nbsp;
**4.** **Regulatory responses**<br>
<!-- bilingual-en:end -->
    
    - 引入 **压力测试、sVaR、IRC、CRM、杠杆率与流动性指标**；
<!-- bilingual-en:start -->
- Add **stress testing, stressed VaR, IRC, comprehensive risk measures, leverage ratios, and liquidity requirements** where relevant.
<!-- bilingual-en:end -->
...
| --- | --- | ---: |
| **Minimum Tier 1 capital** | $0.04\timesRWA$ | Approximately USD 5.73 million |
...
| **Minimum total capital** | $0.08\timesRWA$ | Approximately USD 11.45 million |
<!-- bilingual-en:end -->
...
> <!-- bilingual-en:start -->
> Key steps: calculate $R$ → calculate $K$ → convert to RWA → apply the historical 4% Tier 1 and 8% total-capital minima.
> <!-- bilingual-en:end -->
...
- Historical risk weight: Basel I → 100%; Basel II standardised approach → 20% under the assumption used here
...
<!-- bilingual-en:end -->
 ...
 ① Basel I（无净额）
<!-- bilingual-en:start -->
① Historical Basel I without netting
<!-- bilingual-en:end -->
...
> <!-- bilingual-en:end -->
 ...
 ② Basel I（1995 净额修正案）
<!-- bilingual-en:start -->
② Historical Basel I with the 1995 netting amendment
<!-- bilingual-en:end -->
...
<!-- bilingual-en:start -->
Key steps:
**1.** Keep positive market values and floor negatives at zero.<br>
**2.** Apply the correct product and maturity add-on; gold uses the FX-and-gold row.<br>
**3.** Under Basel I, add CE and PFE, apply the 100% risk weight, and then apply 8% capital.<br>
**4.** Under recognised netting, reduce PFE through the formula and floor net CE at zero.<br>
**5.** Under the Basel II standardised assumption, use the same corrected CEA with the 20% counterparty risk weight.<br>
<!-- bilingual-en:end -->
...
<!-- bilingual-en:start -->
A bank holds USD 500 million of **BBB-rated corporate loans**, with PD = 0.3%, average maturity three years, and LGD = 60%. (1) Calculate credit-risk risk-weighted assets under the Basel II corporate IRB formula; (2) calculate the historical Tier 1 and total-capital minima; and (3) compare the result with the Basel II standardised approach and Basel I.
<!-- bilingual-en:end -->
...
<!-- bilingual-en:end -->
 ...
 ①  IRB 法下风险加权资产 (RWA)
<!-- bilingual-en:start -->
① Risk-weighted assets under IRB
<!-- bilingual-en:end -->
...
&nbsp;
**2.** **Capital coefficient before the maturity adjustment, $K_0$**<br>
...
&nbsp;
**3.** **Maturity adjustment for $M=3$**<br>
...
| **总资本** | 8 % | \$400 m | **\$32 m** |
<!-- bilingual-en:start -->
| Capital item | Ratio | IRB RWA | Amount |
| --- | ---: | ---: | ---: |
...
<!-- bilingual-en:start -->
| Approach | Risk weight or equivalent | RWA (USD m) | Total capital at 8% |
| --- | ---: | ---: | ---: |
| **Basel I** | 100% | 500 | USD 40 million |
| **Basel II standardised approach**, BBB | 100% under the exercise's table | 500 | USD 40 million |
| **Basel II IRB** | Approximately 80% equivalent | **400** | **USD 32 million** |
<!-- bilingual-en:end -->

> **结果**：IRB 法 RWA 较标准法/巴塞尔 I 下降 \$100 m（–20 %），资本需求降低 \$8 m；Tier 1、Tier 2 各减少 \$4 m。  
> <!-- bilingual-en:start -->
> **Result:** IRB produces USD 400 million of RWA, USD 100 million or 20% below the two simplified standardised comparisons. The total-capital minimum falls by USD 8 million; if Tier 1 is held at the historical minimum, Tier 1 and the Tier 2 contribution each fall by USD 4 million.
> <!-- bilingual-en:end -->

**关键步骤**：计算 \(R\) → 求 \(K_0\) → 到期调整 → 折算 RWA → 按 4 % / 8 % 计算 Tier 1 与总资本，再与其他方法对比。
<!-- bilingual-en:start -->
**Key steps:** calculate $R$ → obtain $K_0$ → apply the maturity adjustment → convert to RWA → apply the historical 4% Tier 1 and 8% total-capital minima → compare methods.
<!-- bilingual-en:end -->
