...
相关卡片：[[PCA]]、[[09_因子分析Factor Analysis and Inference for Structured]]、[[Factor Loadings]]、[[Communality]]、[[Specific Variance]]、[[Factor Analysis PC Method]]、[[PCA vs Factor Analysis]]。
