...
1. 先续做最新未完成的 end-to-end unit；不得因跨天而另建 checkbox、Markdown 或新助教会话。
2. Paper A unit 固定走完 `完整材料 → 笔记/map → top-down plan → 200–400 词 critical summary → 整篇反馈/修订`。
...
新技能或句式首次教学仍完成 `理解用途与触发条件 → 有支架练习 → 变式输出 → 放回真实 summary/essay`，但全部嵌在端到端 unit 内。在 guided unit 中，当你接下来要写的句子或段落决定自然适合某个已学/正在学的句式、词汇搭配或写作原则时，助教必须在动笔前即时说明它的功能、为什么适合，并给少量可复用选项；具体句子仍由你写。这类使用记为 `guided`。只有 Friday/timed、明确的完整模拟或导师以后指定的无提示复现才静默观察。
...
- 同一共同 Writing 节点连续两周五没有改善，下一个端到端 unit 在该节点增加教学与反馈时间；仍走完整链，不另补局部练习。
...
- [-] 词灵｜2026-08-14：Demographics 主题词汇复习 30 分钟（两次 15 分钟） #student-os/task ⏳ 2026-08-14 ❌ 2026-08-15
- [x] 词灵｜2026-08-15：25 分钟 #student-os/task ⏳ 2026-08-15 ✅ 2026-08-15
...
- [-] 词灵｜2026-08-23：15 分钟（周日休息，取消） #student-os/cancelled ⏳ 2026-08-23 ❌ 2026-08-17

## Demographics｜端到端训练与测试
...
- [ ] LN905 Paper B guided end-to-end｜Climate Change：三篇正式量级 extracts → map → thesis/paragraph jobs → 约 600 词 essay → 整篇反馈/修订（可跨天）｜[[99_学习情况记录/teach/reading-into-writing/lessons/2026-08-18-climate-end-to-end|学习记录]] #student-os/task ⏳ 2026-08-20
