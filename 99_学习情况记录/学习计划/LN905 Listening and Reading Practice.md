...
- **普通 Reading**：先独立压缩新 source pack 并写 reasoning chain，再让 AI 检查来源角色与跨文关系；修正并取得“可以成文”确认后才写段落，回传一个关键 revision 并由 AI 确认后打勾。
- **完整模拟**：计时期间不使用 AI；计时结束后再提交原始作答，让 AI 诊断并完成一个针对性 revision 后打勾。
...
- [ ] LN905 Listening｜Gender 1：AI 分段结构诊断 + 180–250 词 critical summary（约 60 分钟）｜[[99_学习情况记录/teach/listening-into-writing/lessons/2026-08-03-gender-structure.html|练习页]] #student-os/task ⏳ 2026-08-06 📅 2026-08-06
- [ ] LN905 Reading｜Gender 1：AI 分段论证诊断 + 180–220 词 synthesis paragraph（约 55 分钟）｜[[99_学习情况记录/teach/reading-into-writing/practice/2026-08-03-gender-structure-response|答题页]] #student-os/task ⏳ 2026-08-06 📅 2026-08-06
