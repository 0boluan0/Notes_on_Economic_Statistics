...
\usepackage[left=25mm,right=25mm,top=14mm,bottom=16mm]{geometry}
\usepackage{fontspec}
\setmainfont{Arial}
\usepackage{graphicx}
...
\newcommand{\lseheader}{%
  \noindent\includegraphics[width=58mm]{lse-logo.jpg}\par
  \vspace{1mm}
}
...
\newmdenv[
  ...
  skipabove=2mm,
  skipbelow=0pt,
  innerleftmargin=2.5mm,
  innerrightmargin=2.5mm,
  innertopmargin=0mm,
...
\begin{center}
  {\Large\bfseries Reading into Writing - Climate Change}\par
  \vspace{4mm}
  {\large\bfseries To what extent can adaptation prevent climate change from widening global inequality?}\par
  \vspace{2mm}
  Write an essay of approximately 600 words, using information and ideas from all three extracts.
\end{center}

\begin{extractbox}
\sourceheading{Extract One}{Adapted from: Diffenbaugh, N. S., and Burke, M. (2019). ``Global Warming Has Increased Global Economic Inequality.'' \textit{Proceedings of the National Academy of Sciences, 116}(20), 9808-9813.}
...
\begin{extractbox}
\sourceheading{Extract Two}{Adapted from: Carleton, T. et al. (2022). ``Valuing the Global Mortality Consequences of Climate Change Accounting for Adaptation Costs and Benefits.'' \textit{Quarterly Journal of Economics, 137}(4), 2037-2105.}
...
\begin{extractbox}
\sourceheading{Extract Three}{Adapted from: Berrang-Ford, L. et al. (2021). ``A Systematic Global Stocktake of Evidence on Human Adaptation to Climate Change.'' \textit{Nature Climate Change, 11}, 989-1000.}
