...
- 后续教学必须把词汇访问、句子/段落理解、论证组织和英文成句分开诊断、分层训练。普通学习练习由 AI 主动教学，一次只推进一个极小动作，可使用中文解释、选项、示范、句框和共同成文；只有明确的完整模拟或正式 timed submission 才保留无帮助的考试约束。
