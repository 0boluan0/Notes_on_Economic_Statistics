...
<!-- bilingual-en:start -->
- First study: read Unit I → Unit II → Unit III → Final in order, completing the main text, self-check, and corresponding homework for every session.
- Topic review: use the problem-type entry points below to jump directly to the relevant unit.
- Exam review: open [[04_Review and exam roadmap|Final Course Review and Final Exam]].
- Original materials: open [[MIT_OCW_18.06SC_PDF/index|PDF and transcript index]].
<!-- bilingual-en:end -->
...
<!-- bilingual-en:start -->
1. the coefficient array of a linear system;
2. a collection of column vectors;
3. the coordinate representation of a linear transformation in chosen bases;
4. a rule that stretches, rotates, and flattens directions from the input space into the output space.
<!-- bilingual-en:end -->
...
<!-- bilingual-en:start -->
| Note position | Official topic | Local summary | Homework |
|---:|---|---|---|
| 1.1 | The Geometry of Linear Equations | `Ses1.1` | `Ses1.1` |
| 1.2 | An Overview of Key Ideas | `Ses1.13` | None |
| 1.3 | Elimination with Matrices | `Ses1.2` | `Ses1.2` |
| 1.4 | Multiplication and Inverse Matrices | `Ses1.3` | `Ses1.3` |
| 1.5 | Factorization into $A=LU$ | `Ses1.4` | `Ses1.4` |
| 1.6 | Transposes, Permutations, Vector Spaces | `Ses1.5` | `Ses1.5` |
...
| 1.12 | Matrix Spaces; Rank 1; Small World Graphs | `Ses1.11` | `Ses1.11` |
| 1.13 | Graphs, Networks, Incidence Matrices | `Ses1.12` | `Ses1.12` |
| 1.14 | Exam 1 Review | `Ses1.14` | None |
| Exam 1 | Unit 1 Exam | `ex1/ex1s` | Complete solutions are in Unit I |
<!-- bilingual-en:end -->
...
| 2.11 | Markov Matrices; Fourier Series |
| 2.12 | Exam 2 Review |
| Exam 2 | Unit 2 Exam; complete solutions are in Unit II |
<!-- bilingual-en:end -->
...
<!-- bilingual-en:start -->
| Note position | Official topic | Original lecture number |
|---:|---|---:|
| 3.1 | Symmetric Matrices and Positive Definiteness | Lecture 25 |
| 3.2 | Complex Matrices; FFT | Lecture 26 |
| 3.3 | Positive Definite Matrices and Minima | Lecture 27 |
...
| 3.8 | Left and Right Inverses; Pseudoinverse | Lecture 33 |
| 3.9 | Exam 3 Review | Lecture 32 |
| Exam 3 | Unit 3 Exam; the main scope ends at SVD | — |
<!-- bilingual-en:end -->
...
<!-- bilingual-en:start -->
1. Final Course Review (Lecture 34);
2. Final Exam: three hours and nine integrated problems;
3. The 2023 Final 18.06 Lecture is a later retirement lecture, not part of the Fall 2011 course, and is not counted as a session in these notes.
<!-- bilingual-en:end -->
...
|---|---:|---|
| `01_Exams` | 3 | Final Review, Final Exam, and Final Solutions |
| `02_Exercises` | 6 | Exams 1–3 and their solutions, kept in this directory |
| `03_Homework_Problems` | 31 | Problems for each regular session |
| `04_Homework_Solutions` | 31 | Official solutions corresponding one-to-one with the homework |
| `05_Session_Summaries` | 35 | All session summaries |
| `06_Lecture_Transcripts` | 36 | Transcripts for 35 sessions plus the Final Review |
| `07_Recitation_Transcripts` | 36 | Corresponding problem-solving or recitation transcripts |
| `08_Supplementary_Transcripts` | 2 | Course introduction and an interview on Strang's teaching |
| `99_Books` | 3 | Local textbooks |
<!-- bilingual-en:end -->
...
## 配套知识卡入口
<!-- bilingual-en:start -->
*Entry points to supporting knowledge notes*
<!-- bilingual-en:end -->
...
<!-- bilingual-en:start -->
- Hub: [[线性代数 Course Atlas|Linear Algebra Hub]]
- Problem-type selection: [[线性代数 Course Atlas|Linear Algebra Problem-Type Map]]
- Decomposition selection: [[线性代数 Course Atlas|Choosing Matrix Decompositions]]
- Solution structure: [[线性方程组与四个基本子空间#可解性与完整解|Linear system solution structure]]
- Reading the four subspaces: [[线性方程组与四个基本子空间#四个基本子空间|Reading the Four Fundamental Subspaces from RREF]]
- Least squares: [[正交投影与最小二乘#最小二乘与正规方程|Least Squares via Normal Equations]]
- Positive-definiteness tests: [[对称矩阵与正定二次型#二次型与正定性|Testing Positive Definiteness]]
<!-- bilingual-en:end -->
