...
[[扩展式博弈、逆向归纳与子博弈完美均衡#逆向归纳与可信威胁|进入威慑]]（entry deterrence）是动态博弈的基本例子。
<!-- bilingual-en:start -->
[[扩展式博弈、逆向归纳与子博弈完美均衡#逆向归纳与可信威胁|Entry Deterrence]] is a standard example of a dynamic game.
<!-- bilingual-en:end -->
...
**2.** $z(s)$ is the terminal history induced by strategy profile $s$;<br>
**3.** $v_i(s)=u_i(z(s))$.<br>
<!-- bilingual-en:end -->
...
>[!attention] 只求 NE 不够
> 动态博弈里的纳什均衡可能依赖不可信威胁。要排除它，需要 [[扩展式博弈、逆向归纳与子博弈完美均衡#子博弈完美均衡|子博弈精炼纳什均衡]] 或 [[扩展式博弈、逆向归纳与子博弈完美均衡#逆向归纳与可信威胁|逆向归纳]]。
> <!-- bilingual-en:start -->
> A Nash equilibrium in a dynamic game may rely on a non-credible threat. Eliminating such equilibria requires [[扩展式博弈、逆向归纳与子博弈完美均衡#子博弈完美均衡|Subgame Perfect Nash Equilibrium]] or the [[扩展式博弈、逆向归纳与子博弈完美均衡#逆向归纳与可信威胁|Backward Induction Procedure]].
> <!-- bilingual-en:end -->
...
[[扩展式博弈、逆向归纳与子博弈完美均衡#逆向归纳与可信威胁|逆向归纳]]（backward induction）从最后一个决策节点开始，找出该节点行动者的最优选择，再向前倒推。
<!-- bilingual-en:start -->
[[扩展式博弈、逆向归纳与子博弈完美均衡#逆向归纳与可信威胁|Backward Induction]] starts at the final decision node, identifies the action that is optimal for the player moving there, and then works backwards.
<!-- bilingual-en:end -->
...
[[扩展式博弈、逆向归纳与子博弈完美均衡#逆向归纳与可信威胁|千足虫博弈]]中，玩家轮流选择 Stop 或 Pass。只要有人 Stop，博弈立即结束。
<!-- bilingual-en:start -->
In the [[扩展式博弈、逆向归纳与子博弈完美均衡#逆向归纳与可信威胁|Centipede Game]], players alternately choose Stop or Pass. The game ends immediately when either player chooses Stop.
<!-- bilingual-en:end -->
...
[[扩展式博弈、逆向归纳与子博弈完美均衡#博弈树、信息集与策略|信息集]]（information set）表示某个玩家在行动时无法区分的一组决策节点。
<!-- bilingual-en:start -->
An [[扩展式博弈、逆向归纳与子博弈完美均衡#博弈树、信息集与策略|Information Set]] is a collection of decision nodes that a player cannot distinguish when choosing an action.
<!-- bilingual-en:end -->
...
更一般的 [[扩展式博弈、逆向归纳与子博弈完美均衡#博弈树、信息集与策略|扩展式博弈]] 可以加入自然（nature / chance）。
<!-- bilingual-en:start -->
A more general [[扩展式博弈、逆向归纳与子博弈完美均衡#博弈树、信息集与策略|Extensive-form Game]] may include Nature, or chance.
<!-- bilingual-en:end -->
...
[[扩展式博弈、逆向归纳与子博弈完美均衡#博弈树、信息集与策略|子博弈]]是从一个单点信息集出发、包含其后所有历史、且不切割任何信息集的后续博弈。
<!-- bilingual-en:start -->
A [[扩展式博弈、逆向归纳与子博弈完美均衡#博弈树、信息集与策略|Subgame]] begins at a singleton information set, contains every subsequent history, and does not cut across any information set.
<!-- bilingual-en:end -->
...
[[扩展式博弈、逆向归纳与子博弈完美均衡#子博弈完美均衡|子博弈精炼纳什均衡]]（SPNE）要求策略组合在每一个子博弈中都是纳什均衡。
<!-- bilingual-en:start -->
A [[扩展式博弈、逆向归纳与子博弈完美均衡#子博弈完美均衡|Subgame Perfect Nash Equilibrium]] (SPNE) requires the strategy profile to form a Nash equilibrium in every subgame.
<!-- bilingual-en:end -->
...
- [[博弈的表示、策略与占优#策略式与扩展式|Extensive Form to Strategic Form]]
- [[扩展式博弈、逆向归纳与子博弈完美均衡#逆向归纳与可信威胁|Entry Deterrence]]
- [[扩展式博弈、逆向归纳与子博弈完美均衡#逆向归纳与可信威胁|Credible Threat]]
- [[扩展式博弈、逆向归纳与子博弈完美均衡#逆向归纳与可信威胁|Backward Induction]]
- [[扩展式博弈、逆向归纳与子博弈完美均衡#逆向归纳与可信威胁|Backward Induction Procedure]]
- [[扩展式博弈、逆向归纳与子博弈完美均衡#逆向归纳与可信威胁|Centipede Game]]
- [[扩展式博弈、逆向归纳与子博弈完美均衡#博弈树、信息集与策略|Information Set]]
- [[扩展式博弈、逆向归纳与子博弈完美均衡#博弈树、信息集与策略|Subgame]]
