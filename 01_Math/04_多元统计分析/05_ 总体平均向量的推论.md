# **Chapter 5: Inferences about [[Population Growth and Economic Development|Population]] Mean Vector (总体平均向量的推论)**

## **1. Testing Hypotheses about the Mean Vector (均值向量的假设检验)**
...
• [[Confidence Level|Confidence]] regions for the population mean $\mu$ are ellipsoidal, defined by:
$$
...
• [[Hotelling Model|Hotelling]]’s $T^2$ can be derived as a likelihood ratio test.
...
$$
其中
• $\displaystyle \overline{X} = \frac{1}{n}\sum_{j=1}^n X_j$ 是样本均值 (Sample Mean)；
