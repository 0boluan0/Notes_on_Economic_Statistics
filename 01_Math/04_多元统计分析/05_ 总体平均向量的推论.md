# **Chapter 5: Inferences about Population Mean Vector (总体平均向量的推论)**
...
## **2. Confidence Intervals and Regions (置信区间与置信区域)**
...
## **3. Hotelling’s $T^2$ and Likelihood Ratio Tests (Hotelling's $T^2$ 与似然比检验)**
...
• $s^2 = \tfrac{1}{n-1}\sum_{j=1}^n \bigl(X_j - \overline{X}\bigr)^2$ 是样本方差 (Sample Variance)；
